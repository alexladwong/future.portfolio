...
class Contact extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <ContactTitle scrollPercent={scrollPercent}>REACH ME</ContactTitle>
        <SocialMediaIcons>
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/alexladwong/luziiraprison" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:dev@ladwongdevelopers.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/kintualexladwong/" />
          <SocialLogo imgURL={dribbbleImg} alternate="Dribbble" redirectURL="https://ladwongdevelopers.com" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/ap-kintu-alex-ladwong-8b5629101/" />
        </SocialMediaIcons>
      </Container>
    );
  }
